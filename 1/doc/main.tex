...
Hook \textit{WH\_KEYBOARD\_LL} lze ale použít i bez okna - je však nutné zavolat funkci \mintinline{c}{GetMessage(...)}.
...
Na závěr je však nutné, aby funkce zavolala \mintinline{c}{CallNextHookEx} čímž se může zavolat hook v další aplikaci.
